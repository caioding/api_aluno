...
/**
   ...
   * `prisma.aluno`: Exposes CRUD operations for the **Aluno** model.
    ...
    * ```
    */
  get aluno(): Prisma.AlunoDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type AlunoAggregateArgs = {
    /**
  ...
  type GetAlunoGroupByPayload<T extends AlunoGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type AlunoGetPayload<
    S extends boolean | null | undefined | AlunoArgs,
    U = keyof S
      > = S extends true
        ? Aluno
    : S extends undefined
    ? never
    : S extends AlunoArgs | AlunoFindManyArgs
    ?'include' extends U
    ? Aluno 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Aluno ? Aluno[P] : never
  } 
    : Aluno
  : Aluno


  type AlunoCountArgs = Merge<
    Omit<AlunoFindManyArgs, 'select' | 'include'> & {
      select?: AlunoCountAggregateInputType | true
    }
  >

  export interface AlunoDelegate<GlobalRejectSettings> {
    /**
     ...
     * })
    **/
    findUnique<T extends AlunoFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, AlunoFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Aluno'> extends True ? CheckSelect<T, Prisma__AlunoClient<Aluno>, Prisma__AlunoClient<AlunoGetPayload<T>>> : CheckSelect<T, Prisma__AlunoClient<Aluno | null >, Prisma__AlunoClient<AlunoGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends AlunoFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, AlunoFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Aluno'> extends True ? CheckSelect<T, Prisma__AlunoClient<Aluno>, Prisma__AlunoClient<AlunoGetPayload<T>>> : CheckSelect<T, Prisma__AlunoClient<Aluno | null >, Prisma__AlunoClient<AlunoGetPayload<T> | null >>
     ...
     * 
    **/
    findMany<T extends AlunoFindManyArgs>(
      args?: SelectSubset<T, AlunoFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Aluno>>, PrismaPromise<Array<AlunoGetPayload<T>>>>
     ...
     * 
    **/
    create<T extends AlunoCreateArgs>(
      args: SelectSubset<T, AlunoCreateArgs>
    ): CheckSelect<T, Prisma__AlunoClient<Aluno>, Prisma__AlunoClient<AlunoGetPayload<T>>>
     ...
     *     
    **/
    createMany<T extends AlunoCreateManyArgs>(
      args?: SelectSubset<T, AlunoCreateManyArgs>
     ...
     * 
    **/
    delete<T extends AlunoDeleteArgs>(
      args: SelectSubset<T, AlunoDeleteArgs>
    ): CheckSelect<T, Prisma__AlunoClient<Aluno>, Prisma__AlunoClient<AlunoGetPayload<T>>>
     ...
     * 
    **/
    update<T extends AlunoUpdateArgs>(
      args: SelectSubset<T, AlunoUpdateArgs>
    ): CheckSelect<T, Prisma__AlunoClient<Aluno>, Prisma__AlunoClient<AlunoGetPayload<T>>>
     ...
     * 
    **/
    deleteMany<T extends AlunoDeleteManyArgs>(
      args?: SelectSubset<T, AlunoDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends AlunoUpdateManyArgs>(
      args: SelectSubset<T, AlunoUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends AlunoUpsertArgs>(
      args: SelectSubset<T, AlunoUpsertArgs>
    ): CheckSelect<T, Prisma__AlunoClient<Aluno>, Prisma__AlunoClient<AlunoGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends AlunoAggregateArgs>(args: Subset<T, AlunoAggregateArgs>): PrismaPromise<GetAlunoAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, AlunoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAlunoGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   */
  export class Prisma__AlunoClient<T> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  export type AlunoFindUniqueArgs = {
     ...
     * 
    **/
    select?: AlunoSelect | null
    /**
     * Throw an Error if a Aluno can't be found
     * 
    **/
   ...
   * Aluno findFirst
   */
  export type AlunoFindFirstArgs = {
    /**
     * Select specific fields to fetch from the Aluno
     * 
    **/
   ...
   * Aluno createMany
   */
  export type AlunoCreateManyArgs = {
    /**
   ...
   * Aluno updateMany
   */
  export type AlunoUpdateManyArgs = {
    /**
   ...
   * Aluno deleteMany
   */
  export type AlunoDeleteManyArgs = {
    /**
